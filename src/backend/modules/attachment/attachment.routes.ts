...
import { mustBeRequestorOrResourceOwner, mustOwnResource } from '../../utils/authorization';
...
const paths: Paths = {
    '/attachment': {
        post: {
            ...
            requestBody: {
                description: 'Create a new URL attachment. Not used for file attachments.',
                required: true,
                content: {
                    'application/json': {
                        schema: {
    ...
    '/sep/{sepID}/attachment/upload': {
        post: {
            ...
            requestBody: {
                description: 'Upload a new version of an existing attachment. Don`t forget the enctype="multipart/form-data" in your form. The "name" property on the file input must be "attachment".',
                required: true,
                content: {
                    'multipart/form-data': {
                        schema: {
