...
const uploadFile = async (req: express.Request, attachment: AttachmentModel, transaction: Transaction) => {
...
const attachmentController = {
    ...
    updateURLAttachment: async (
        ...
        if (attachment.mimeType) {
            return res.status(400).send('This endpoint can only be used to update URL attachments.')
        }
